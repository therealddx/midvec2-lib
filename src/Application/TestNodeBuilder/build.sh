...
# build.
g++ main.cpp TestNodeBuilder.cpp \
  ...
  -lpthread --std=c++11 -I"$PATH_SRC" -o "$PWD"/bin/TestNodeBuilder.out

# leave these files here for testing.
touch bin/Test_byteNodePs_inFile.txt
